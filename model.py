...
class EncoderCNN(nn.Module):
    def __init__(self, embed_size, freeze=False):
        ...
        if freeze==True:
            resnet = freeze_layers(resnet)
        else:
            resnet = unfreeze_layers(resnet)
...
# take pretrained models and will freeze
def freeze_layers(freeze_model):
...
# take pretrained models and will freeze
def unfreeze_layers(freeze_model):
